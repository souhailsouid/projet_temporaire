...
function style (chooseYourColor) { 
  const styles = {
  backgroundColor: chooseYourColor,
    color: whiteColor,
    boxShadow:
      "0 2px 2px 0 rgba(" +
      hexToRgb(chooseYourColor) +
...
const buttonStyle = {
  ...
  celadonGreen: style(celadonGreenColor[0]),
  celadonGray: {
    backgroundColor: celadonGrayColor,
    color: whiteColor,
    boxShadow:
      "0 2px 2px 0 rgba(" +
      hexToRgb(celadonGrayColor) +
      ", 0.14), 0 3px 1px -2px rgba(" +
      hexToRgb(celadonGrayColor) +
      ", 0.2), 0 1px 5px 0 rgba(" +
      hexToRgb(celadonGrayColor) +
  ...
  zenika:  style(zenikaColor[0]) 
  ,
  celadonBlue: {
    backgroundColor: celadonBlueColor,
    color: whiteColor,
    boxShadow:
      "0 2px 2px 0 rgba(" +
      hexToRgb(celadonBlueColor) +
      ", 0.14), 0 3px 1px -2px rgba(" +
      hexToRgb(celadonBlueColor) +
      ", 0.2), 0 1px 5px 0 rgba(" +
      hexToRgb(celadonBlueColor) +
  ...
  simple: {
    ...
    "&$celadonGreen": {
      "&,&:focus,&:hover,&:visited": {
        color: celadonGreenColor[0],
      },
    },
    "&$celadonGray": {
      "&,&:focus,&:hover,&:visited": {
        color: celadonGrayColor,
      },
    },
    "&$celadonBlue": {
      "&,&:focus,&:hover,&:visited": {
