...
const customCheckboxRadioSwitch = {
  checkRoot: {
    ...
    "&:hover": {
      backgroundColor:
        "rgba(" + hexToRgb(celadonGreenColor[0]) + ", 0.14) !important",
    },
  },
  radioRoot: {
    padding: "16px",
  ...
  checked: {
    color: celadonGreenColor[0] + "!important",
  },
  checkedIcon: {
    width: "20px",
    height: "20px",
  ...
  radioChecked: {
    width: "16px",
    height: "16px",
    border: "1px solid " + celadonGreenColor[0],
    borderRadius: "50%",
  },
  radioUnchecked: {
    width: "0px",
  ...
  switchIconChecked: {
    borderColor: celadonGreenColor[0],
  ...
  switchChecked: {
    "& + $switchBar": {
      backgroundColor:
        "rgba(" + hexToRgb(celadonGreenColor[0]) + ", 1) !important",
    },
    "& $switchIcon": {
      borderColor: celadonGreenColor[0],
    },
